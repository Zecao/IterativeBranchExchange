% roda the choosen algorithm
function [populacao, fitness] = runAlgorithm(algoritmo, alim, populacao, fitness, k)
...
switch algoritmo
    ...
    case 521 % ED / So busca local    
        ...
        [populacao, fitness] = iterativeBranchExchange521(alim, populacao, fitness, k);  
